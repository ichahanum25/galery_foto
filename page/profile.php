                ...
                <div class="card-body">
                    ...
                    <?php echo @$alert; if (@$_GET['proses'] == 'editprofile') : ?>
                        <form action="?url=profile&&proses=editprofile" method="post">
                            ...
                            <div class="input-group mb-3">
                                <label for="username" class="input-group-text"><i class="fa-solid fa-envelope fa-fw fa-lg" ></i></label>
                                <input type="text" class="form-control" value="<?= $user['username'] ?>" id="username" name="username" required placeholder="Masukan Username">
                            </div>
                            <div class="input-group mb-3">
                                <label for="alamat" class="input-group-text"><i class="fa-solid fa-envelope fa-fw fa-lg" ></i></label>
                                <input type="text" class="form-control" value="<?= $user['alamat'] ?>" id="alamat" name="alamat" required placeholder="Masukan Alamat Lengkap">
                            </div>
                        ...
                        <?php else : ?>
                            ...
                            <a href="?url=profile&&proses=editprofile" class="btn btn-info">Edit Profile</a>
